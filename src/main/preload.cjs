...
contextBridge.exposeInMainWorld('bridge', {
  ...
  getCacheDirectoryInfo: () => ipcRenderer.invoke('getCacheDirectoryInfo'),
  selectCacheDirectory: () => ipcRenderer.invoke('selectCacheDirectory'),
  resetCacheDirectory: () => ipcRenderer.invoke('resetCacheDirectory'),
  ...
  getConcertEvents: (options) => ipcRenderer.invoke('getConcertEvents', options),
  ...
  onVolumeAssistWheel: (callback) => bind('volume-assist-wheel', callback),
