...
contextBridge.exposeInMainWorld('bridge', {
  ...
  detectAiCli: (provider, cliPath) => ipcRenderer.invoke('detectAiCli', provider, cliPath),
  listOllamaModels: (cliPath) => ipcRenderer.invoke('listOllamaModels', cliPath),
  aiChatStart: (payload) => ipcRenderer.invoke('aiChatStart', payload),
  aiChatCancel: (sessionId) => ipcRenderer.invoke('aiChatCancel', sessionId),
  onAiChatEvent: (callback) => bind('ai-chat-event', callback),
